 ...
 --print one more ":"
    */
    ...
    SUBCASE("p8scii special control code for rhs wrap(\\^r) ") {
        ...
        print("\x06"
              "rsthis is a long string that should wrap somewhere",
              0, 0);
    ...
    SUBCASE("p8scii special control code for pinball option(\\^p) ") {
        ...
        std::vector<coloredPoint> expectedPoints = {
            {2, 0, 0}, {3, 0, 0}, {2, 1, 0}, {3, 1, 0}, {2, 2, 6}, {3, 2, 0}, {2, 3, 0}, {3, 3, 0}, {2, 4, 0}, {3, 4, 0}, {2, 5, 0}, {3, 5, 0}, {2, 6, 6}, {3, 6, 0}, {2, 7, 0}, {3, 7, 0}, {2, 8, 0}, {3, 8, 0}, {2, 9, 0}, {3, 9, 0}};
    ...
    SUBCASE("p8scii custom font control code (\\014 on and \\015 off)") {
        ...
        std::vector<coloredPoint> expectedPoints = {
            {0, 0, 6}, {1, 0, 0}, {0, 1, 6}, {1, 1, 6}, {2, 1, 0}, {0, 2, 6}, {1, 2, 6}, {2, 2, 6}, {3, 2, 0}, {0, 3, 6}, {1, 3, 6}, {2, 3, 6}, {3, 3, 6}, {4, 3, 0}, {0, 4, 6}, {1, 4, 6}, {2, 4, 6}, {3, 4, 6}, {4, 4, 6}, {5, 4, 0}, {0, 5, 6}, {1, 5, 6}, {2, 5, 6}, {3, 5, 6}, {4, 5, 6}, {5, 5, 6}, {6, 5, 0}, {0, 6, 6}, {1, 6, 6}, {2, 6, 6}, {3, 6, 6}, {4, 6, 6}, {5, 6, 6}, {6, 6, 6}, {7, 6, 0}, {0, 7, 6}, {1, 7, 6}, {2, 7, 6}, {3, 7, 6}, {4, 7, 6}, {5, 7, 6}, {6, 7, 6}, {7, 7, 6}, {7, 8, 0}, {0, 8, 0}
    ...
    SUBCASE("p8scii special control code for outline(\\^o) ") {
        graphics->cls(2);
