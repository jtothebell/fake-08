...
TEST_CASE("Loading and running carts") {
    ...
    SUBCASE("nested long comment/long string test"){
        vm->LoadCart("nested_comment_test.p8");
        ...
        SUBCASE("sceen matches screenshot"){
            ...
            CHECK(verifyScreenshot(vm, host, "carts/screenshots/nested_comment_test_f01.png"));
        }
