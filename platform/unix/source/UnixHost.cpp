...
string _unixPrefPath = SDL_GetPrefPath("fake-08", "fake-08");
string _desktopSdl2SettingsDir = _unixPrefPath;
string _desktopSdl2SettingsPrefix = _unixPrefPath;
...
Host::Host()
{
    ...
    int res = chdir(getenv(_unixPrefPath.c_str()));
